...
files_to_copy = ['grenland_bridge.inp', '1-Skrastag.bsp', '2-Viadukt.bsp']
...
for itr in range(iterations):
    ...
    lower_allowable_theta = np.array([0.27E+10, 2000, 2.1E+10, 7000])
    upper_allowable_theta = np.array([0.27E+12, 3000, 2.1E+12, 9000])

    # Local parameter bounds
    lb_local = np.array([0.95, 0.95, 0.95, 0.95])
    ub_local = np.array([1.05, 1.05, 1.05, 1.05])
